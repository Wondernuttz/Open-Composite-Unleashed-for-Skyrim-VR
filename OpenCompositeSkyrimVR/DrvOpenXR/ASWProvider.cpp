...
bool ASWProvider::CreateDX12ComputePipeline()
{
	...
	std::string csMainDX12Src = std::string(s_warpShaderHLSL);
	...
	std::string fullDX12Src = std::string(s_warpShaderHLSL) + s_forwardScatterHLSL;
...
// (Diagnostic capture code removed — WriteBMP, WriteRaw, CopyAndSaveTexture, CaptureWarpDiagnostics)
